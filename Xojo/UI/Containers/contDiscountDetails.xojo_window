#tag Window
Begin ContainerControl contDiscountDetails
   AcceptFocus     =   False
   AcceptTabs      =   True
   AutoDeactivate  =   True
   BackColor       =   &cFFFFFF00
...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		oCurrentRecord As DataFile.tbl_group_discounts
	#tag EndProperty


#tag EndWindowCode

#tag Events tfGroupName
	#tag Event
		Sub LostFocus()
		  
		  oCurrentRecord.sgroup_name = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events tfGroupDiscount
	#tag Event
		Sub LostFocus()
