...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub AddLinkedItem(LinkType as string,CreateNewOrUseExisting as string = "")
		  ...
		  Case "Use Existing"
		    ...
		    suuids = winPicker.MyShowModal(oCurrentInventoryItem.suuid)
		    ...
		    For Each suuid as String In sUUIDs()
		      ...
		      oItem = DataFile.tbl_inventory.FindByID(suuid)
		  ...
		  For Each oChild as DataFile.tbl_inventory In iLinkTheseToParent
		    ...
		    oLinkItem.sfk_parent = oCurrentInventoryItem.suuid
	...
	#tag Method, Flags = &h0
		Sub LoadItem(oItem as DataFile.tbl_inventory)
		  ...
		  If oCurrentInventoryItem.suuid <> "" Then
		    ...
		    contInventoryExpanded.PickerMode = True
		  End If
	...
	#tag Method, Flags = &h0
		Sub LoadItem(suuid as String)
		  dim oItem as DataFile.tbl_inventory
		  
		  // load inventory item record into oCurrentInventoryItem with the uuid passed
		  oItem = DataFile.tbl_inventory.FindByID(suuid)
...
#tag Events pbIncreaseQuantity
	#tag Event
		Sub Action()
		  ...
		  Methods.UpdateItemQuantity(oCurrentInventoryItem.suuid)
		  
		  dim olbUI as lbUIState
		  olbUI = contInventoryExpanded.lbItems.GetUIState
		  LoadItem(oCurrentInventoryItem.suuid)
