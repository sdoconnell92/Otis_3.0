...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub AddLinkedContactable(CreateNewOrUseExisting as string = "")
		  ...
		  For Each oChild as DataFile.tbl_contactables In oLinkTheseToParent
		    ...
		    oLinkItem.sfk_parent = oCurrentEvent.suuid
	...
	#tag Method, Flags = &h0
		Sub AddLinkedEvent(CreateNewOrUseExisting as string = "")
		  ...
		  Case "Use Existing"
		    ...
		    dim sUUIDs() as String
		    sUUIDs = winPicker.MyShowModal(oCurrentEvent.suuid)
		    
		    // Loop through the selected uuids and create an array of table objects for them
		    For Each sUUID as string In sUUIDs()
		      
		      // Get the item from the database based on uuid
		      dim oEvent as DataFile.tbl_events
		      oEvent = DataFile.tbl_events.FindByID(sUUID)
		      ...
		      aroLinkedRecords() = DataFile.tbl_internal_linking.List(" fk_parent = '" + oCurrentEvent.suuid + "' And fk_table_name != 'tbl_events'" )
		      ...
		      If aroLinkedRecords.Ubound <> -1 Then
		        For Each oLinkedRecord as DataFile.tbl_internal_linking In aroLinkedRecords()
		          ...
		          oNewLink.sfk_parent = oEvent.suuid
		          oNewLink.sfk_child = oLinkedRecord.sfk_child
	...
	#tag Method, Flags = &h0
		Sub LoadEvent(oEvent as DataFile.tbl_events)
		  ...
		  // Contactables list
		  instEventContactablesList.EventID = oEvent.suuid
