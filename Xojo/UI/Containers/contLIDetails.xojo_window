#tag Window
Begin ContainerControl contLIDetails
   AcceptFocus     =   False
   AcceptTabs      =   True
   AutoDeactivate  =   True
   BackColor       =   &cFFFFFF00
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub LoadMe(oRecord as DataFile.tbl_lineitems)
		  
		  oCurrentRecord = oRecord
		  
		  // IItem Type popup
		  dim sValue as string = oCurrentRecord.sli_type
		  For i1 as integer = 0 To pmType.ListCount - 1
		    If pmType.List(i1) = sValue Then
		      pmType.ListIndex = i1
		      exit
		    End If
		  Next
	...
	#tag Method, Flags = &h0
		Sub LoadMe(sUUID as String)
		  ...
		  If sUUID <> "" Then
		    oCurrentRecord = DataFile.tbl_lineitems.FindByID(sUUID)
		    LoadMe(oCurrentRecord)
		  End If
		End Sub
	#tag EndMethod
	...
	#tag Property, Flags = &h0
		oCurrentRecord As DataFile.tbl_lineitems
	#tag EndProperty
...
#tag Events tfName
	#tag Event
		Sub LostFocus()
		  ...
		  oCurrentRecord.sli_name = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events tfManufacturer
	#tag Event
		Sub LostFocus()
		  
		  oCurrentRecord.sli_manufacturer = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events tfDepartment
	#tag Event
		Sub LostFocus()
		  
		  oCurrentRecord.sli_department = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events tfModel
	#tag Event
		Sub LostFocus()
		  ...
		  oCurrentRecord.sli_model = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events pmType
	#tag Event
		Sub Open()
		  ...
		  dim s1() as string = ValueRef.ItemTypes.Split(",")
	...
	#tag Event
		Sub Change()
		  ...
		  oCurrentRecord.sli_type = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events tfSubCategory
	#tag Event
		Sub LostFocus()
		  
		  oCurrentRecord.sli_subcategory = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events tfDescription
	#tag Event
		Sub LostFocus()
		  ...
		  oCurrentRecord.sli_description = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events tfCategory
	#tag Event
		Sub LostFocus()
		  
		  oCurrentRecord.sli_category = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events tfRate
	#tag Event
		Sub LostFocus()
		  ...
		  oCurrentRecord.sli_rate = me.Text
		  oCurrentRecord.Save
		End Sub
	#tag EndEvent
#tag EndEvents
