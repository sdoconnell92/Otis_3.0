...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub methBuildRowTag(ByRef oRowTag as lbRowTag)
		  ...
		  If oRowTag.vtblRecord IsA DataFile.tbl_eipl Then  '!@! Table Dependent !@!
		    ...
		    arLinkArray = DataFile.tbl_internal_linking.List( "fk_parent = '" + otblRecord.suuid + "' And fk_table_name = 'tbl_eipl'" )
		    ...
		    If arLinkArray.Ubound <> -1 Then
		      ...
		      For Each oLinkRecord as DataFile.tbl_internal_linking In arLinkArray
		        ...
		        dim oChild as DataFile.tbl_eipl = DataFile.tbl_eipl.FindByID( oLinkRecord.sfk_child )  '!@! Table Dependent !@!
		        If oChild <> Nil Then
	...
	#tag Method, Flags = &h0
		Function methGetRecordList_Grouped(sGroupByField as string, sConditionpar as string) As Dictionary
		  ...
		  If oEventRecord <> Nil Then arsConditions.Append( "fkevents = '" + oEventRecord.suuid +"'" )
		  ...
		  Case "Open"
		    ...
		    If lbEIPLs.ListIndex <> -1 Then
		      ...
		      If oRowTag.uuid <> "" Then
		        ...
		        conItem.methLoadMe(oRowTag.uuid)
		      End If
		    End If
