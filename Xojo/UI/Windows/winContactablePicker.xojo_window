#tag Window
Begin Window winContactablePicker
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   True
   Compatibility   =   ""
   ...
   Visible         =   True
   Width           =   366
   Begin contContactableList instContactableList
      AcceptFocus     =   False
      AcceptTabs      =   True
      AutoDeactivate  =   True
      BackColor       =   &cFFFF00FF
...
#tag WindowCode
	...
	#tag Property, Flags = &h0
		oSelectedRecords() As DataFile.tbl_contactables
	#tag EndProperty


#tag EndWindowCode

#tag Events instContactableList
	#tag Event
		Sub evdefOpen()
